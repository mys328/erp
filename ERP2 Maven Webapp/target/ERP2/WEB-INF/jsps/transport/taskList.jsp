			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>供&nbsp;应&nbsp;商:</td>
						<td>
							<s:select name="oqm.sm.name" list="ordersList" listKey="sm.uuid" listValue="sm.name" headerKey="-1" headerValue="---请-选-择---" cssStyle="width:115px"></s:select>
						</td>
						<td>下单人:</td>
						<td>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="ordersList">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>${sm.needsView }</td>
							<td>
								<s:if test=" type == @cn.itcast.erp.invoice.orders.vo.OrdersModel@ORDER_TYPE_OF_BUY_CHECK_PASS">
