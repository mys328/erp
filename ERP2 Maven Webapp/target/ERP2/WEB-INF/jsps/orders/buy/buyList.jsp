...
<div class="content-right">
	...
	<div class="content-text">
		<s:form action="orders_buyList" method="post"> 
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>
							<s:select name="oqm.type" list="@cn.itcast.erp.invoice.orders.vo.OrdersModel@buyTypeMap" headerKey="-1" headerValue="--请-选-择--" cssClass="width:113px;"></s:select> 
						</td>
						<td>下单人:</td>
						<td>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="ordersList">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>
								<s:a action="orders_orderDetail.action" cssClass="xiu">
