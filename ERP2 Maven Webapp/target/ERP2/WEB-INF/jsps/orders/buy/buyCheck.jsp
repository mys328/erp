	...
	<div class="content-text">
			...
			<div class="square-order">
				...
				<table width="100%">
					<tr align="center">
						<td width="50%">
							<s:a action="orders_buyCheckPass.action" cssStyle="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								通&nbsp;&nbsp;过
								<s:param name="om.uuid" value="om.uuid"/>
							</s:a>
						</td>
						<td width="50%">
							<s:a action="orders_buyCheckNoPass.action" cssStyle="color:#f00;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								驳&nbsp;&nbsp;回
								<s:param name="om.uuid" value="om.uuid"/>
							</s:a>
						</td>
