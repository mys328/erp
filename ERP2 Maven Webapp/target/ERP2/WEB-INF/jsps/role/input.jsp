...
<script type="text/javascript">
	...
	$(function(){
		$("#all").click(function(){
			//alert("ddfdf");
			var flag = $("[name=resesUuid]").attr("checked");
			$("[name=resesUuid]").attr("checked",!(flag=="checked"));
		});
		
		$("#reverse").click(function(){
			$("[name=resesUuid]").each(function(){
				//var flag = $("[name=resesUuid]").attr("checked");
				//$(this)这是当前的对象
				$(this).attr("checked",!$(this).attr("checked"));
				/*var flag = $("[name=resesUuid]").attr("checked");
				if(flag != "checked"){
					$("[name=resesUuid]").attr("checked", "");
				}*/
				selectAll();
			});
		});
		
		$("[name=resesUuid]").click(function(){
			selectAll();
		});
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      	<s:textfield name="rm.name" size="38"/>
				      </td>
				      <td width="18%" align="center">角色编码</td>
				      <td width="32%">
						<s:textfield name="rm.code" size="38"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
				      	...
				      	<s:checkboxlist name="resesUuid" list="resList" listKey="uuid" listValue="name"></s:checkboxlist>
				      </td>
				    </tr>
				     <tr  bgcolor="#FFFFFF">
