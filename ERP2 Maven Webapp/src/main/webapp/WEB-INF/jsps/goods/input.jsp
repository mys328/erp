...
<script type="text/javascript">
	...
	$(function(){
		$("#supplier").change(function(){
			$.post("goodsType_ajaxGetBySm.action",{"gm.sm.uuid":$(this).val()},function(data){
				if(data.gtmList.length == 0){
					alert("不要搞事！！");
					return;
				}
				//清空数据
				...
				for(var i = 0; i < gtmList.length; i++){
					var gtm = gtmList[i];
					//创建option
					var $option = $("<option value='gtm.uuid'>"+gtm.name+"</option>");
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
						<s:select id="goodsType" name="gm.gtm.uuid" list="goodsTypeList" listKey="uuid" listValue="name" cssStyle="width:190px;"></s:select>
					  </td>
				    </tr>
				    <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
