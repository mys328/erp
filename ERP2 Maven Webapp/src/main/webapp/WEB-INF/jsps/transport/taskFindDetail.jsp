				...
				<table width="100%">
					<tr>
						<td width="50%" align="center">
							<s:if test=" om.type == @cn.itcast.erp.invoice.orders.vo.OrdersModel@ORDER_TYPE_OF_BUY_BUYING">
							<s:a action="transport_endOrder.action" cssStyle="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								结&nbsp;&nbsp;单
